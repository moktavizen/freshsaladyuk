<x-layout>
    ...
    <div class="bg-white">
        <div class="mx-auto max-w-7xl py-20 sm:px-6 sm:py-32 lg:px-8">
            <div
                class="relative isolate overflow-hidden bg-lime-600 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
    ...
    <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl bg-lime-600 px-6 py-24 sm:rounded-3xl sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-7xl py-24 sm:py-32 sm:px-6 lg:px-8">
        <h2 class="text-center text-3xl font-bold tracking-tight text-lime-900 sm:text-4xl">Contact Us</h2>
