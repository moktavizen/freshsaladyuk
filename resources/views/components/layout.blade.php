...
<body>
    {{-- navbar --}}
    <header class="fixed top-0 z-10 w-full bg-white/70 backdrop-blur-lg">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="{{ route('home') }}" class="-m-1.5 p-1.5">
                    <span class="sr-only">Fresh Salad</span>
                    <img class="h-8 w-auto" src="{{ asset('/images/fresh-logo.png') }}" alt="">
                </a>
            </div>
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <a href="{{ route('home') }}"
                    class="text-sm font-semibold leading-6 text-lime-900 hover:text-lime-600">Beranda</a>
                <div class="relative">
                    <form action="/product/1">
                        <button type="submit"
                            class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-lime-900 hover:text-lime-600"
                            aria-expanded="false">
                            Produk
                            <svg class="h-5 w-5 flex-none text-lime-900" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true">
              ...
              -->
                ...
                <a href="{{ route('profile') }}"
                    class="text-sm font-semibold leading-6 text-lime-900 hover:text-lime-600">Profil</a>
            </div>
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <a target="_blank" rel="noopener noreferrer" href="admin"
                    class="text-sm font-semibold leading-6 text-lime-900 hover:text-lime-600">Log in <span
    ...
    {{-- footer --}}
    <div class="bg-white p-6 text-center text-sm text-gray-600 lg:px-8 lg:text-base">
