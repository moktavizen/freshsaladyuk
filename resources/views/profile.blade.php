<x-layout>
    <section class="body-font pt-20 text-gray-600">
        <div class="mx-auto max-w-2xl px-4 py-8 sm:px-6 sm:py-12 lg:max-w-7xl lg:px-8">
            <div class="mb-20 flex w-full flex-col text-center">
                <h1 class="title-font mb-4 text-3xl font-bold tracking-tight text-lime-900 sm:text-4xl">Our Team</h1>
                            ...
                            <span class="inline-flex">
                                <a class="text-gray-500">
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" class="h-5 w-5" viewBox="0 0 24 24">
                    ...
                    <div
                        ...
                        <div class="flex-grow sm:pl-8">
                            ...
                            <span class="inline-flex">
                                ...
                                <a class="ml-2 text-gray-500">
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" class="h-5 w-5"
                                        viewBox="0 0 24 24">
                                        <path
                                            d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z">
                                        </path>
